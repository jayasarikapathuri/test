<%@page import="com.rs.fer.bean.Balance"%>
...
<%@page import="com.rs.fer.bean.UserSession"%>
<%
...
<table>
	<tr>
		<td colspan="2" align="center" style="color: green; padding-left: 260px; "> 
			<font size="5">Family Maintenace Report</font>
		</td>
		<td align="right" style="padding-left: 158px;">
...
<table>	
	<tr>
		<td colspan="2" align="left" width="500px">
			<img alt="your uploaded image" src="<%="upload/"+userSession.getImagePath()%>" width="80px" height="80px">
		</td>
